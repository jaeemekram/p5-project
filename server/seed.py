...
if __name__ == '__main__':
    with app.app_context():
        ...
        c1 = Client(username="ChettGPT", password=fake.password(), first_name="Chett", last_name="Tiller", email=fake.email(), dob_month=randint(1,13), dob_day=randint(1,31), dob_year=randint(1972,2011), gender="M", weight=randint(100,201), img1="https://static.wikia.nocookie.net/nickelodeon/images/7/7d/Larry_with_Speedo.png/revision/latest?cb=20230415005534",img2="", img3="", about="", city=rc([city for city in cities]))
        c2 = Client(username="Sbob", password=fake.password(), first_name="Spongebob", last_name="Squarepants", email=fake.email(), dob_month=randint(1,13), dob_day=randint(1,31), dob_year=randint(1972,2011), gender="M", weight=randint(100,201), img1="https://i.imgflip.com/e9j3q.jpg?a475056",img2="", img3="", about="", city=rc([city for city in cities]))
        c3 = Client(username="BigCat420", password=fake.password(), first_name="Tom", last_name="Cat", email=fake.email(), dob_month=randint(1,13), dob_day=randint(1,31), dob_year=randint(1972,2011), gender="M", weight=randint(100,201), img1="https://i.pinimg.com/564x/4c/2d/5b/4c2d5baeee3c5055482ba6606391bd83.jpg",img2="", img3="", about="", city=rc([city for city in cities]))
        c4 = Client(username="BettOnMe", password=fake.password(), first_name="Betty", last_name="Boop", email=fake.email(), dob_month=randint(1,13), dob_day=randint(1,31), dob_year=randint(1972,2011), gender="F", weight=randint(100,201), img1="https://indian-retailer.s3.ap-south-1.amazonaws.com/s3fs-public/article4843.jpg",img2="", img3="", about="", city=rc([city for city in cities]))
        c5 = Client(username="LOLBunz", password=fake.password(), first_name="Lola", last_name="Bunny", email=fake.email(), dob_month=randint(1,13), dob_day=randint(1,31), dob_year=randint(1972,2011), gender="F", weight=randint(100,201), img1="https://i.pinimg.com/564x/20/c3/03/20c303a867a9b0b8b0ce503504542dec.jpg",img2="", img3="", about="", city=rc([city for city in cities]))
        c6 = Client(username="CheeksOfTheSand", password=fake.password(), first_name="Sandy", last_name="Cheeks", email=fake.email(), dob_month=randint(1,13), dob_day=randint(1,31), dob_year=randint(1972,2011), gender="F", weight=randint(100,201),img1="https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/048c8356-1a5c-4b2d-93ad-0eb6c5c77873/de2gxdo-76158f39-f6c2-46d6-9cbc-b9daac9e7b05.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..MppIdXaM43kotvk8t7iEEv_EWl6mAtLa12Pk99vyrzs",img2="", img3="", about="", city=rc([city for city in cities]))
        ...
        ###TRAINER INSTANCES
        t1=Trainer(username="JaeemTheDream", password=fake.password(), first_name="Jaeem", last_name="Ekram", email=fake.email(), dob_month=randint(1,13), dob_day=randint(1,31), dob_year=randint(1972,2011), gender="M", weight=randint(100,201), img1="",img2="", img3="", about="", is_certified="cert-pic " , city=rc([city for city in cities]))
        t2=Trainer(username="HeresJohnny", password=fake.password(), first_name="Johnny", last_name="Bravo", email=fake.email(), dob_month=randint(1,13), dob_day=randint(1,31), dob_year=randint(1972,2011), gender="M", weight=randint(100,201), img1="https://1.bp.blogspot.com/-xnWU73LIBu4/YVBmXTiR5VI/AAAAAAAAnVg/6hgKibonMjo0sts-8HbKeyOGU05cbsZ-wCLcBGAsYHQ/s720/3378021.jpg",img2="", img3="", about="", is_certified="cert-pic " , city=rc([city for city in cities]))
        t3=Trainer(username="PoppaPops", password=fake.password(), first_name="Popeye", last_name="TheSailor", email=fake.email(), dob_month=randint(1,13), dob_day=randint(1,31), dob_year=randint(1972,2011), gender="M", weight=randint(100,201), img1="https://i.pinimg.com/originals/05/c1/ab/05c1ab65b1b2e336fe3cb321b9d4ea46.png",img2="", img3="", about="", is_certified="cert-pic " , city=rc([city for city in cities]))
        t4=Trainer(username="FlexNoBox", password=fake.password(), first_name="Helen", last_name="Parr", email=fake.email(), dob_month=randint(1,13), dob_day=randint(1,31), dob_year=randint(1972,2011), gender="F", weight=randint(100,201), img1="https://upload.wikimedia.org/wikipedia/en/thumb/e/ef/Helen_Parr.png/220px-Helen_Parr.png",img2="", img3="", about="", is_certified="cert-pic ", city=rc([city for city in cities]) )
        t5=Trainer(username="LionQueen", password=fake.password(), first_name="Nala", last_name="Lion", email=fake.email(), dob_month=randint(1,13), dob_day=randint(1,31), dob_year=randint(1972,2011), gender="F", weight=randint(100,201), img1="https://i.pinimg.com/736x/04/ae/3e/04ae3e55bfd8d859ebf55138c56458f0.jpg",img2="", img3="", about="", is_certified="cert-pic ", city=rc([city for city in cities]) )
        t6=Trainer(username="DrippyBender", password=fake.password(), first_name="Katara", last_name="OfTheWaterTribe", email=fake.email(), dob_month=randint(1,13), dob_day=randint(1,31), dob_year=randint(1972,2011), gender="F", weight=randint(100,201), img1="https://m.media-amazon.com/images/I/91SpCtx31AL._AC_UF1000,1000_QL80_.jpg",img2="", img3="", about="", is_certified="cert-pic ", city=rc([city for city in cities]) )
        ...
        ts1 = TrainerSpecialty(trainer_id=rc([trainer.id for trainer in trainers]), specialty_id=rc([specialty.id for specialty in specialties]))
        ts2 = TrainerSpecialty(trainer_id=rc([trainer.id for trainer in trainers]), specialty_id=rc([specialty.id for specialty in specialties]))
        ts3 = TrainerSpecialty(trainer_id=rc([trainer.id for trainer in trainers]), specialty_id=rc([specialty.id for specialty in specialties]))
        ts4 = TrainerSpecialty(trainer_id=rc([trainer.id for trainer in trainers]), specialty_id=rc([specialty.id for specialty in specialties]))
        ts5 = TrainerSpecialty(trainer_id=rc([trainer.id for trainer in trainers]), specialty_id=rc([specialty.id for specialty in specialties]))
        ts6 = TrainerSpecialty(trainer_id=rc([trainer.id for trainer in trainers]), specialty_id=rc([specialty.id for specialty in specialties]))
        ts7 = TrainerSpecialty(trainer_id=rc([trainer.id for trainer in trainers]), specialty_id=rc([specialty.id for specialty in specialties]))
        ts8 = TrainerSpecialty(trainer_id=rc([trainer.id for trainer in trainers]), specialty_id=rc([specialty.id for specialty in specialties]))
        ts9 = TrainerSpecialty(trainer_id=rc([trainer.id for trainer in trainers]), specialty_id=rc([specialty.id for specialty in specialties]))
        ts10 = TrainerSpecialty(trainer_id=rc([trainer.id for trainer in trainers]), specialty_id=rc([specialty.id for specialty in specialties]))
